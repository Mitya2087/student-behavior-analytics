...
col_time = 'Когда ты впервые задумался о том чтобы пойти на курсы/взять репета?'
...
time_map = {
    ...
    'Я считаю что сдам своими силами': 'Самостоятельно'
}
df['time_group'] = df[col_time].map(time_map)
order_time = ['10 класс (перв. пол)', '10 класс (втор. пол)', '11 класс (перв. пол)', '11 класс (втор. пол)', 'Самостоятельно']
...
save_plot('2.1_thinking_about_preparation.png', 'Когда задумались о репете/курсах', '', 'Процент опрошенных (%)')
